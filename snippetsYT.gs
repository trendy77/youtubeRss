...
/**
 * This example lists caption tracks available for the Volvo Trucks "Epic Split" commercial, featuring Jean-Claude Van Damme. (This video was selected because 
...
/**
 * This example retrieves the channel data for the authorized user's YouTube channel. It uses the mine request parameter to indicate that the API should 
...
/**
 * This example retrieves the channel sections shown on the authorized user's channel. It uses the mine request parameter to indicate that the API should 
...
/**
 * This example retrieves comment replies for a specified comment, which is  * identified by the parentId request parameter. In this example, the parent 
 * comment is the first comment on a video about Apps Script. The video was chosen  * because this particular comment had multiple replies (in multiple languages) 
...
/**
 * This example retrieves all comment threads associated with a particular  * channel. The response could include comments about the channel or about the 
 * channel's videos. The request's allThreadsRelatedToChannelId parameter  * identifies the channel. 
 */
...
/**
 * This example retrieves all comment threads about the specified channel. The  * request's channelId parameter identifies the channel. The response does not 
...
/**
 * This example retrieves a list of application languages that the YouTube website  * supports. The example sets the hlparameter value to es_MX, indicating that text 
 * values in the API response should be provided in that language. That  * parameter's default value is en_US. 
 */
...
/**
 * This example retrieves a list of content regions that the YouTube website  * supports. The example sets the hlparameter value to es_MX, indicating that text 
 * values in the API response should be provided in that language. That  * parameter's default value is en_US. 
 */
...
Note that the API response does not include metadata about the playlist itself, such as the playlist's title and description. Additional metadata about the videos in the playlist can also be retrieved using the videos.listmethod. 
 */
...
/**
 * This example retrieves playlists created in the authorized user's YouTube  * channel. It uses the mine request parameter to indicate that the API should 
...
/**
 * This example retrieves the first 25 search results associated with the keyword  * surfing. Since the request doesn't specify a value for the type request 
...
/**
 * This example retrieves search results associated with the keyword surfing that  * also specify in their metadata a geographic location within 10 miles of the 
 * point identified by the location parameter value. (The sample request specifies * a point on the North Shore of Oahu, Hawaii . The request retrieves the top five 
 * results, which is the default number returned when the maxResults parameter is  * not specified. 
 */
...
/**
 * This example retrieves a list of acdtive live broadcasts (see the eventType  * parameter value) that are associated with the keyword news. Since the eventType 
...
/**
 * This example searches within the authorized user's videos for videos that match  * the keyword fun. The forMine parameter indicates that the response should only 
 * search within the authorized user's videos. Also, since this request uses the * forMine parameter, it must also set the type parameter value to video.
...
/**
 * This example sets the relatedToVideoId parameter to retrieve a list of videos  * related to that video. Since the relatedToVideoId parameter is set, the request 
...
/**
 * This example retrieves a list of channels that the specified channel subscribes to. In this example, the API response lists channels to which the GoogleDevelopers channel 
 * subscribes. 
 */
...
/**
 * This example determines whether the user authorizing the API request subscribes to the channel that the forChannelId parameter identifies. To check whether 
 * another channel (instead of the authorizing user's channel) subscribes to the specified channel, remove the mine parameter from this request and add the channelId parameter 
 * instead.
...
/**
 * This example uses the mySubscribers parameter to retrieve the list of channels to which the authorized user subscribes. 
 */
...
/**
 * This example retrieves a list of categories that can be associated with YouTube videos in the United States. The regionCode parameter specifies the country for 
...
/**
 * This example retrieves a list of YouTube's most popular videos. The regionCode parameter identifies the country for which you are retrieving videos. The 
 * sample code is set to default to return the most popular videos in the United States. You could also use the videoCategoryId parameter to retrieve the most popular videos in a particular category. 
 */
...
/**
 * This example retrieves information about a group of videos. The id parameter value is a comma-separated list of YouTube video IDs. You might issue a request 
 * like this to retrieve additional information about the items in a playlist or the results of a search query. 
 */
...
/**
 * This example retrieves the rating that the user authorizing the request gave to * a particular video. In this example, the video is of Amy Cuddy's TED talk about body language. 
 */
